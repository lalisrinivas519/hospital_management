                     ...
                     <div class="row clearfix">
                        <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                           <div class="footer-widget logo-widget">
                              ...
                              <div class="text">
                                 <p>Transforming healthcare with a commitment to excellence, compassion, and innovation</p>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="widget-content">
                                 <ul class="info-list clearfix">
                                    <li><i class="fas fa-map-marker-alt"></i>
                                      Near Mother Dairy, Next to D Mart, Mathru layout, Yelahanka New Town, Bengaluru - 560064
                                    </li>
                                    <li><i class="fas fa-microphone"></i>
                                       <a href="tel:23055873407">+91 9513228259</a>
                                    </li>
                                    <li><i class="fas fa-envelope"></i>
                                       <a href="mailto:info@example.com"> info@vivatech.me</a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
               ...
               <div class="auto-container">
                  <div class="inner-box clearfix">
                     <div class="copyright pull-left">
                        <p><a href="index.php">Docpro</a> &copy; 2024 All Right Reserved</p>
                     </div>
