      ...
      <div class="boxed_wrapper">
               ...
               <div class="row align-items-center clearfix">
                  <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                     <div class="content-box">
                        ...
                        <p>Guiding lights on the path to healing and well-being.</p>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                     <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                           ...
                           <div class="btn-box"><a href="#" class="theme-btn-one">Chat now<i class="icon-Arrow-Right"></i></a></div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
         ...
         <section class="cta-section bg-color-2">
            <div class="pattern-layer">
               ...
               <div class="pattern-3" style="background-image: url(assets/images/shape/shape-19.png);"></div>
            </div>
            <div class="auto-container">
               <div class="row clearfix">
                  <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                     <div class="content_block_2">
                        <div class="content-box">
                           ...
                           <div class="text">
                              <p>Transforming healthcare with a commitment to excellence, compassion, and innovation, our hospital stands as a beacon of healing and hope in our community. </p>
                           </div>
                     ...
                     <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                           ...
                           <div class="lower-content">
                              ...
                              <ul class="post-info">
                                 <li><img src="assets/images/news/admin-1.png" alt=""><a href="#">Eva Green</a></li>
                                 <li>April 10, 2020</li>
                              </ul>
                              <p>we're dedicated to empowering lives and fostering wellness at every step of the journey.</p>
                              <div class="link"><a href="#"><i class="icon-Arrow-Right"></i></a></div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                     <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                           ...
                           <div class="lower-content">
                              <h3><a href="#">Baking can be done with a few things.</a></h3>
                              <ul class="post-info">
                                 <li><img src="assets/images/news/admin-2.png" alt=""><a href="#">George Clooney</a></li>
                                 <li>April 09, 2020</li>
                              </ul>
                              <p>we're dedicated to empowering lives and fostering wellness at every step of the journey.</p>
                              <div class="link"><a href="#"><i class="icon-Arrow-Right"></i></a></div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                     <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                           ...
                           <div class="lower-content">
                              <h3><a href="#">Great food is not just eating energy.</a></h3>
                              <ul class="post-info">
                                 <li><img src="assets/images/news/admin-3.png" alt=""><a href="#">George Clooney</a></li>
                                 <li>April 08, 2020</li>
                              </ul>
                              <p>we're dedicated to empowering lives and fostering wellness at every step of the journey.</p>
                              <div class="link"><a href="#"><i class="icon-Arrow-Right"></i></a></div>
                        ...
                        <div class="content_block_3">
                           <div class="content-box">
                              ...
                              <div class="support-box">
                                 ...
                                 <span>Telephone</span>
                                 <h3><a href="tel:11165458856">+91 9513228259</a></h3>
                              </div>
                           </div>
                        </div>
                     </div>
