                     ...
                     <div class="image_block_1">
                        <div class="image-box">
                           <div class="pattern">
                              ...
                              <div class="pattern-3" style="background-image: url(assets/images/shape/shape-16.png);"></div>
                           </div>
...
Doctors are medical professionals who diagnose, treat, and prevent illnesses, injuries, and other health conditions in humans. They undergo extensive education and training to obtain the necessary knowledge and skills to care for patients effectively. 							  </p>
                           </div>
                           <ul class="list-style-one clearfix">
                              <li>Associates Insurance</li>
                              <li>Pina & Insurance</li>
                           </ul>
                           <div class="btn-box"><a href="about_us.php" class="theme-btn-one">About Us<i class="icon-Arrow-Right"></i></a></div>
                        </div>
                     </div>
                  </div>
               </div>
